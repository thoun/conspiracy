...
$lordGameStates = [
    ST_PLAYER_LORD_STACK_SELECTION => array(
        ...
        'descriptionlimitToHidden' => clienttranslate('${actplayer} must choose between ${limitToHidden} lord(s) from deck (Location constraint)'),
        "descriptionmyturn" => clienttranslate('${you} must choose lords from deck or from a discard pile'),
        'descriptionmyturnlimitToHidden' => clienttranslate('${you} must choose between ${limitToHidden} lord(s) from deck (Location constraint)'),
        "type" => "activeplayer",
...
$locationGameStates = [
    ...
    ST_PLAYER_LOCATION_STACK_SELECTION => array(
        ...
        'descriptionnallHidden' => clienttranslate('${actplayer} must choose a location from all deck (Location constraint)'),
