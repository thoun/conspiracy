...
$lordGameStates = [
    ...
    ST_PLAYER_LORD_SELECTION => array(
        ...
        "descriptionmultiple" => clienttranslate('${actplayer} must choose the first lord to place'),
        "descriptionlast" => clienttranslate('${actplayer} must place the last lord'),
        "descriptionmyturn" => clienttranslate('${you} must choose the lord to recruit'),
        "descriptionmyturnmultiple" => clienttranslate('${you} must choose the first lord to place'),
...
$locationGameStates = [
    ...
    ST_PLAYER_LOCATION_STACK_SELECTION => array(
        ...
        'descriptionallHidden' => clienttranslate('${actplayer} must choose a location from all deck (Location constraint)'),
