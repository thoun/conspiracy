...
$lordGameStates = [
    ST_PLAYER_LORD_STACK_SELECTION => array(
        ...
        'descriptionlimitToHidden2' => clienttranslate('${actplayer} must choose pick 2 lords from deck and choose 1 (Location constraint)'),
        ...
        'descriptionmyturnlimitToHidden2' => clienttranslate('${you} must choose pick 2 lords from deck and choose 1 (Location constraint)'),
        "type" => "activeplayer",
