...
$lordGameStates = [
    ST_PLAYER_LORD_STACK_SELECTION => array(
        ...
        'descriptionlimitToHidden' => clienttranslate('${actplayer} must choose ${limitToHidden} lord(s) from deck (Location constraint)'),
        "descriptionmyturn" => clienttranslate('${you} must choose lords from deck or from a discard pile'),
        'descriptionmyturnlimitToHidden' => clienttranslate('${you} must choose ${limitToHidden} lord(s) from deck (Location constraint)'),
        "type" => "activeplayer",
